<div class="container p-3">
    ...
    <div class="row p-2">
        ...
        <div class="col-10">
            <input required value='<?=$editora['nome']?>' type="text" name="nome" id="nome" class="form-control">
        </div>
    </div>
    <div class="row p-2">
        <div class="col-2">
    ...
    <div class="row p-4">
        ...
        <a href="http://localhost:8080/index.php/Editora/index" class="btn btn-outline-secondary">X</a>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input value='<?=$editora['id']?>' type="hidden" name="id">
                            <p>Você deseja excluir a editora <?=$editora['nome']?></p>
                        </div>
                    </div>
